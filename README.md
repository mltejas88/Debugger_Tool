...
- Filter out the required trace events in log_entries.csv files using command :  python3 parse_trace_log.py raw_log.txt log_entries.csv
- Visualize the filtered dat using command : python3 visualize.py log_entries.csv output
