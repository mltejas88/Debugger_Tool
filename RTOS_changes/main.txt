...
TaskHandle_t h1, h2, h3, hPrinter, hFlush;
...
{
    vTaskDelay(pdMS_TO_TICKS(1000));   // Wait 10 seconds
...
extern "C" void app_main() {
    ...
    xTaskCreate(produceItem1, "produceItem1", 4096, NULL, 2, &h1);
    xTaskCreate(produceItem2, "produceItem2", 4096, NULL, 2, &h2);
    //xTaskCreate(produceItem3, "produceItem3", 8192, NULL, 2, &h3);
    xTaskCreate(sharedPrinter, "sharedPrinter", 4096, NULL, 3, &hPrinter); 
